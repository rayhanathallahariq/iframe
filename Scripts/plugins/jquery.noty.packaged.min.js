 ...
 */
    ...
    t = {
        ...
        _build: function() {
            ...
            this.$bar = this.options.layout.parent.object !== null ? n(this.options.layout.parent.object).css(this.options.layout.parent.css).append(t) : t;
            ...
            this.options.layout.parent.object !== null ? this.$bar.find(".noty_bar").append(i) : this.$bar.append(i),
            r = this,
        ...
        show: function() {
            var t = this;
            if (t.options.custom ? t.options.custom.find(t.options.layout.container.selector).append(t.$bar) : n(t.options.layout.container.selector).append(t.$bar),
            t.options.theme && t.options.theme.style && t.options.theme.style.apply(t),
            n.type(t.options.layout.css) === "function" ? this.options.layout.css.apply(t.$bar) : t.$bar.css(this.options.layout.css || {}),
            ...
            if (n.inArray("button", t.options.closeWith) == -1 && t.$closeButton.remove(),
            t.options.callback.onShow && t.options.callback.onShow.apply(t),
            typeof t.options.animation.open == "string") {
            ...
            return t.options.timeout && t.$bar.delay(t.options.timeout).promise().done(function() {
                t.close()
            }),
            this
        },
        close: function() {
            ...
            if (!this.closed && (!this.$bar || !this.$bar.hasClass("i-am-closing-now"))) {
                ...
                if (t.$bar.addClass("i-am-closing-now"),
                t.options.callback.onClose && t.options.callback.onClose.apply(t),
                typeof t.options.animation.close == "string")
                    t.$bar.addClass(t.options.animation.close).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
        ...
        closeCleanUp: function() {
            var t = this;
            if (t.options.modal && (n.notyRenderer.setModalCount(-1),
            n.notyRenderer.getModalCount() == 0 && n(".noty_modal").fadeOut("fast", function() {
                n(this).remove()
            })),
            n.notyRenderer.setLayoutCountFor(t, -1),
            n.notyRenderer.getLayoutCountFor(t) == 0 && n(t.options.layout.container.selector).remove(),
            typeof t.$bar != "undefined" && t.$bar !== null)
                if (typeof t.options.animation.close == "string") {
                    t.$bar.css("transition", "all 100ms ease").css("border", 0).css("margin", 0).height(0);
    ...
    n.notyRenderer.init = function(i) {
        ...
        n.notyRenderer.render(),
        n.noty.returns == "object" ? r : r.options.id
    }
    ;
    n.notyRenderer.render = function() {
        var t = n.noty.queue[0];
        n.type(t) === "object" ? t.options.dismissQueue ? t.options.maxVisible > 0 ? n(t.options.layout.container.selector + " li").length < t.options.maxVisible && n.notyRenderer.show(n.noty.queue.shift()) : n.notyRenderer.show(n.noty.queue.shift()) : n.noty.ontap && (n.notyRenderer.show(n.noty.queue.shift()),
